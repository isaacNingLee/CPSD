...
from metrics.cl_metrics import backward_transfer, forward_transfer, forgetting

useless_args = ['dataset', 'tensorboard', 'validation', 'model',
                'csv_log', 'notes', 'load_best_args']


def print_mean_accuracy(mean_acc: np.ndarray, task_number: int) -> None:
    """
...
class Logger:
    ...
    def write(self, args: Dict[str, Any], output_dir) -> None:
        """
        ...
        target_folder = output_dir + "/results/"
